...
/* harmony import */ var _language_buttons_language_buttons_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../language-buttons/language-buttons.module */ "./src/app/language-buttons/language-buttons.module.ts");
...
SigninPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [
            ...
            _language_buttons_language_buttons_module__WEBPACK_IMPORTED_MODULE_8__["LanguageButtonsModule"],
        ],
...
let SigninPage = class SigninPage {
    constructor(statusBar, formBuilder, api, router) {
            ...
            this.api.signin(body).subscribe(val => {
                ...
                if (this.val['status'] == 1) {
                    ...
                    if (this.val && this.val.data.token) {
                        ...
                        localStorage.setItem("permission", JSON.stringify(this.val.user_permission));
                    }
