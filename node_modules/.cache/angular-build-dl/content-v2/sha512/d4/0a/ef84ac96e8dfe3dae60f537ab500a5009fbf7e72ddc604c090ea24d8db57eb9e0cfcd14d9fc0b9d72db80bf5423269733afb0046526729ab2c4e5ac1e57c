...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["common"], {
  ...
  /***/
  function srcAppGlobalPassword_validationTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var PasswordValidation = /*#__PURE__*/function () {
      ...
      _createClass(PasswordValidation, null, [{
        ...
        key: "ResetPassword",
        value: function ResetPassword(AC) {
          var new_password = AC.get('new_password').value; // to get value in input tag
