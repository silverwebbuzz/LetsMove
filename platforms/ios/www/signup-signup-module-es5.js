...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["signup-signup-module"], {
  ...
  /***/
  function node_modulesGoogleLibphonenumberDistLibphonenumberJs(module, exports, __webpack_require__) {
    var require;
        ...
        1: [function (require, module, exports) {
          (function (global) {
            ...
            */
            ...
            goog.exportPath_ = function (a, b, c, d) {
              ...
              for (var e; a.length && (e = a.shift());) {
                if (a.length || void 0 === b) d = d[e] && d[e] !== Object.prototype[e] ? d[e] : d[e] = {};else if (!c && goog.isObject(b) && goog.isObject(d[e])) for (var f in b) {
              ...
              for (var a = this, b = this.paused_; this.depsToLoad_.length && !b;) {
                (function () {
                  ...
                  var f = {
                    ...
                    registerEs6ModuleExports: function registerEs6ModuleExports(g, h, k) {
            ...
            goog.array.count = function (a, b, c) {
              var d = 0;
              goog.array.forEach(a, function (e, f, g) {
                b.call(c, e, f, g) && ++d;
              }, c);
              return d;
            };
            ...
            goog.array.stableSort = function (a, b) {
              ...
              goog.array.sort(c, function (f, g) {
            ...
            goog.array.sortObjectsByKey = function (a, b, c) {
              goog.array.sortByKey(a, function (d) {
                return d[b];
              }, c);
            };
            ...
            goog.html.SafeUrl.trySanitize = function (a) {
              ...
              return goog.html.SAFE_URL_PATTERN_.test(a) ? goog.html.SafeUrl.createSafeUrlSecurityPrivateDoNotAccessOrElse(a) : null;
            };
            ...
            goog.html.SafeStyleSheet.concat = function (a) {
              var b = "",
                  c = function c(d) {
                Array.isArray(d) ? goog.array.forEach(d, c) : b += goog.html.SafeStyleSheet.unwrap(d);
              };
            ...
            goog.proto2.Descriptor.prototype.getFields = function () {
              ...
              goog.array.sort(a, function (b, c) {
            ...
            goog.proto2.Message.prototype.initDefaults = function (a) {
              for (var b = this.getDescriptor().getFields(), c = 0; c < b.length; c++) {
                ...
                if (f) if (d.isRepeated()) for (d = this.array$Values(e), e = 0; e < d.length; e++) {
                  d[e].initDefaults(a);
            ...
            */
            ...
            i18n.phonenumbers.PhoneNumberUtil.VALID_PUNCTUATION = "-x\u2010-\u2015\u2212\u30FC\uFF0D-\uFF0F \xA0\xAD\u200B\u2060\u3000()\uFF08\uFF09\uFF3B\uFF3D.\\[\\]/~\u2053\u223C\uFF5E";
            ...
            i18n.phonenumbers.PhoneNumberUtil.EXTN_PATTERNS_FOR_PARSING_ = i18n.phonenumbers.PhoneNumberUtil.RFC3966_EXTN_PREFIX_ + i18n.phonenumbers.PhoneNumberUtil.CAPTURING_EXTN_DIGITS_ + "|[ \xA0\\t,]*(?:e?xt(?:ensi(?:o\u0301?|\xF3))?n?|\uFF45?\uFF58\uFF54\uFF4E?|\u0434\u043E\u0431|[;,x\uFF58#\uFF03~\uFF5E]|int|anexo|\uFF49\uFF4E\uFF54)[:\\.\uFF0E]?[ \xA0\\t,-]*" + i18n.phonenumbers.PhoneNumberUtil.CAPTURING_EXTN_DIGITS_ + "#?|[- ]+([" + i18n.phonenumbers.PhoneNumberUtil.VALID_DIGITS_ + "]{1,5})#";
            ...
            i18n.phonenumbers.PhoneNumberUtil.prototype.getSupportedGlobalNetworkCallingCodes = function () {
              var a = goog.array.filter(Object.keys(i18n.phonenumbers.metadata.countryToMetadata), function (b) {
                return !isNaN(b);
              });
              return goog.array.map(a, function (b) {
            ...
            i18n.phonenumbers.PhoneNumberUtil.prototype.getSupportedCallingCodes = function () {
              ...
              return goog.array.join(this.getSupportedGlobalNetworkCallingCodes(), goog.array.map(a, function (b) {
                return parseInt(b, 10);
              }));
            };
            ...
            i18n.phonenumbers.PhoneNumberUtil.prototype.formatOutOfCountryCallingNumber = function (a, b) {
              ...
              b = "";
              i18n.phonenumbers.PhoneNumberUtil.matchesEntirely(i18n.phonenumbers.PhoneNumberUtil.SINGLE_INTERNATIONAL_PREFIX_, f) ? b = f : e.hasPreferredInternationalPrefix() && (b = e.getPreferredInternationalPrefixOrDefault());
            ...
            i18n.phonenumbers.PhoneNumberUtil.prototype.getExampleNumberForNonGeoEntity = function (a) {
              ...
              if (null != b && (b = goog.array.find([b.getMobile(), b.getTollFree(), b.getSharedCost(), b.getVoip(), b.getVoicemail(), b.getUan(), b.getPremiumRate()], function (c, d) {
            ...
            i18n.phonenumbers.PhoneNumberUtil.prototype.testNumberLengthForType_ = function (a, b, c) {
              ...
              a = a.length;
              if (-1 < goog.array.indexOf(d, a)) return i18n.phonenumbers.PhoneNumberUtil.ValidationResult.IS_POSSIBLE_LOCAL_ONLY;
              b = e[0];
            ...
            i18n.phonenumbers.PhoneNumberUtil.prototype.extractCountryCode = function (a, b) {
              ...
              for (var c, d = a.length, e = 1; e <= i18n.phonenumbers.PhoneNumberUtil.MAX_LENGTH_COUNTRY_CODE_ && e <= d; ++e) {
                if (c = parseInt(a.substring(0, e), 10), c in i18n.phonenumbers.metadata.countryCodeToRegionCodeMap) return b.append(a.substring(e)), c;
              }
            ...
            i18n.phonenumbers.PhoneNumberUtil.prototype.maybeStripExtension = function (a) {
              ...
              if (0 <= c && i18n.phonenumbers.PhoneNumberUtil.isViablePhoneNumber(b.substring(0, c))) for (var d = b.match(i18n.phonenumbers.PhoneNumberUtil.EXTN_PATTERN_), e = d.length, f = 1; f < e; ++f) {
            ...
            i18n.phonenumbers.shortnumbermetadata.countryToMetadata = {
              ...
              AR: [, [,, "[01389]\\d{1,4}",,,,,,, [2, 3, 4, 5]],,, [,, "000|1(?:0[0-35-7]|1[0245]|2[015]|34|4[478]|9)|911",,,, "19",,, [2, 3]], [,,,,,,,,, [-1]],,,, "AR",,,,,,,,,,,,,,,,,, [,, "10[017]|911",,,, "100",,, [3]],, [,, "000|1(?:0[0-35-7]|1[02-5]|2[015]|34|4[478]|9)|3372|89338|911",,,, "19"], [,,,,,,,,, [-1]], [,, "893\\d\\d",,,, "89300",,, [5]],, [,, "(?:337|893\\d)\\d",,,, "3370",,, [4, 5]]],
              ...
              FI: [, [,, "[17]\\d\\d(?:\\d{2,3})?",,,,,,, [3, 5, 6]],,, [,, "11(?:2|6\\d{3})",,,, "112",,, [3, 6]], [,,,,,,,,, [-1]],,,, "FI",,,,,,,,,,,,,,,,,, [,, "112",,,, "112",,, [3]],, [,, "11(?:2|611[17])|75[12]\\d\\d",,,, "112"], [,,,,,,,,, [-1]], [,,,,,,,,, [-1]],, [,,,,,,,,, [-1]]],
              ...
              SA: [, [,, "[19]\\d{2,5}",,,,,,, [3, 4, 5, 6]],,, [,, "11(?:2|6\\d{3})|9(?:11|37|9[7-9])",,,, "112",,, [3, 6]], [,,,,,,,,, [-1]],,,, "SA",,,,,,,,,,,,,,,,,, [,, "112|9(?:11|9[79])",,,, "112",,, [3]],, [,, "1(?:1(?:00|2|6111)|410|9(?:00|1[89]|9(?:099|22|9[12])))|9(?:0[24-79]|11|3[379]|40|66|8[5-9]|9[02-9])",,,, "112"], [,, "141\\d",,,, "1410",,, [4]], [,, "1(?:10|41)\\d|90[24679]",,,, "902",,, [3, 4]],, [,,,,,,,,, [-1]]],
            ...
            */
            ...
            i18n.phonenumbers.ShortNumberInfo.prototype.isPossibleShortNumberForRegion = function (a, b) {
              ...
              return goog.array.contains(b.getGeneralDesc().possibleLengthArray(), a);
            };
            ...
            i18n.phonenumbers.ShortNumberInfo.prototype.isPossibleShortNumber = function (a) {
              ...
              for (var c = 0; c < b.length; c++) {
                ...
                if (d && (d = d.getGeneralDesc().possibleLengthArray(), goog.array.contains(d, a))) return !0;
              }
  ...
  /***/
  function node_modulesNgxIntlTelInput__ivy_ngcc__Fesm2015NgxIntlTelInputJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CountryISO", function () {
      return CountryISO;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NativeElementInjectorDirective", function () {
      return NativeElementInjectorDirective;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NgxIntlTelInputComponent", function () {
      return NgxIntlTelInputComponent;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NgxIntlTelInputModule", function () {
      return NgxIntlTelInputModule;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "NgxIntlTelInputService", function () {
      return NgxIntlTelInputService;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "SearchCountryField", function () {
      return SearchCountryField;
    });
    /* harmony export (binding) */


    __webpack_require__.d(__webpack_exports__, "TooltipLabel", function () {
      return TooltipLabel;
    });
    /* harmony export (binding) */
    ...
    var google_libphonenumber__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! google-libphonenumber */
    "./node_modules/google-libphonenumber/dist/libphonenumber.js");
    /* harmony import */


    var google_libphonenumber__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(google_libphonenumber__WEBPACK_IMPORTED_MODULE_2__);
    /* harmony import */
    ...
    function NgxIntlTelInputComponent_div_6_div_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngModelChange", function NgxIntlTelInputComponent_div_6_div_1_Template_input_ngModelChange_1_listener($event) {
    ...
    function NgxIntlTelInputComponent_div_6_li_4_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function NgxIntlTelInputComponent_div_6_li_4_Template_li_click_0_listener() {
    ...
    function NgxIntlTelInputComponent_div_6_li_6_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function NgxIntlTelInputComponent_div_6_li_6_Template_li_click_0_listener() {
    ...
    var NgxIntlTelInputService = function NgxIntlTelInputService() {
      _classCallCheck(this, NgxIntlTelInputService);
    };
    ...
    NgxIntlTelInputService.ɵprov = Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"])({
    ...
    NgxIntlTelInputService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [])], NgxIntlTelInputService);
    var CountryISO;
    ...
    CountryCode.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjectable"]({
      token: CountryCode,
    ...
    */
    ...
    var phoneNumberValidator = function phoneNumberValidator(control) {
      if (!control.value) {
        return;
    ...
    var NgxIntlTelInputComponent = NgxIntlTelInputComponent_1 = /*#__PURE__*/function () {
      function NgxIntlTelInputComponent(countryCodeData) {
        _classCallCheck(this, NgxIntlTelInputComponent);
      ...
      _createClass(NgxIntlTelInputComponent, [{
        key: "ngOnInit",
        ...
        */
        ...
        value: function getPreferredCountries() {
          ...
          if (this.preferredCountries.length) {
            ...
            this.preferredCountries.forEach(function (iso2) {
              var preferredCountry = _this2.allCountries.filter(function (c) {
                return c.iso2 === iso2;
              });

              _this2.preferredCountriesInDropDown.push(preferredCountry[0]);
            });
          }
        }
      }, {
        ...
        value: function getSelectedCountry() {
          ...
          if (this.selectedCountryISO) {
            this.selectedCountry = this.allCountries.find(function (c) {
              return c.iso2.toLowerCase() === _this3.selectedCountryISO.toLowerCase();
            });
        ...
        value: function searchCountry() {
          ...
          var country = this.allCountries.filter(function (c) {
            if (_this4.searchCountryField.indexOf(SearchCountryField.All) > -1) {
              ...
              if (c.dialCode.startsWith(_this4.countrySearchText)) {
                return c;
              }
            } else {
              // Or search by specific SearchCountryField(s)
              if (_this4.searchCountryField.indexOf(SearchCountryField.Iso2) > -1) {
                if (c.iso2.toLowerCase().startsWith(countrySearchTextLower)) {
                  return c;
                }
              }

              if (_this4.searchCountryField.indexOf(SearchCountryField.Name) > -1) {
                if (c.name.toLowerCase().startsWith(countrySearchTextLower)) {
                  return c;
                }
              }

              if (_this4.searchCountryField.indexOf(SearchCountryField.DialCode) > -1) {
                if (c.dialCode.startsWith(_this4.countrySearchText)) {
                  return c;
                }
              }
        ...
        value: function onPhoneNumberChange() {
          ...
          } catch (e) {} // auto select country based on the extension (and areaCode if needed) (e.g select Canada if number starts with +1 416)
          ...
          if (!this.value) {
            ...
            var intlNo = number ? this.phoneUtil.format(number, google_libphonenumber__WEBPACK_IMPORTED_MODULE_2__["PhoneNumberFormat"].INTERNATIONAL) : ''; // parse phoneNumber if separate dial code is needed
            ...
            this.propagateChange({
              ...
              nationalNumber: number ? this.phoneUtil.format(number, google_libphonenumber__WEBPACK_IMPORTED_MODULE_2__["PhoneNumberFormat"].NATIONAL) : '',
              e164Number: number ? this.phoneUtil.format(number, google_libphonenumber__WEBPACK_IMPORTED_MODULE_2__["PhoneNumberFormat"].E164) : '',
        ...
        value: function fetchCountryData() {
          ...
          this.countryCodeData.allCountries.forEach(function (c) {
            ...
            if (_this5.enablePlaceholder) {
              country.placeHolder = _this5.getPhoneNumberPlaceHolder(country.iso2.toUpperCase());
            }

            _this5.allCountries.push(country);
          });
        }
      }, {
        ...
        key: "separateDialCodePlaceHolder",
        value: function separateDialCodePlaceHolder(placeholder) {
    ...
    NgxIntlTelInputComponent.ɵfac = function NgxIntlTelInputComponent_Factory(t) {
      return new (t || NgxIntlTelInputComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](CountryCode));
    };

    NgxIntlTelInputComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({
      ...
      features: [_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵProvidersFeature"]([CountryCode, {
        provide: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["NG_VALUE_ACCESSOR"],
        // tslint:disable-next-line:no-forward-ref
        useExisting: Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["forwardRef"])(function () {
          return NgxIntlTelInputComponent_1;
        }),
        multi: true
      }, {
      ...
      template: function NgxIntlTelInputComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("blur", function NgxIntlTelInputComponent_Template_input_blur_7_listener() {
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "value", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)], NgxIntlTelInputComponent.prototype, "preferredCountries", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "enablePlaceholder", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "cssClass", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)], NgxIntlTelInputComponent.prototype, "onlyCountries", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "enableAutoCountrySelect", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "searchCountryFlag", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Array)], NgxIntlTelInputComponent.prototype, "searchCountryField", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "searchCountryPlaceholder", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "maxLength", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)], NgxIntlTelInputComponent.prototype, "tooltipField", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "selectFirstCountry", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", String)], NgxIntlTelInputComponent.prototype, "selectedCountryISO", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "phoneValidation", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "inputId", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "separateDialCode", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])(), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", Object)], NgxIntlTelInputComponent.prototype, "countryChange", void 0);
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('countryList'), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"])], NgxIntlTelInputComponent.prototype, "countryList", void 0);
    NgxIntlTelInputComponent = NgxIntlTelInputComponent_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [CountryCode])], NgxIntlTelInputComponent);
    /*
    "Property 'nativeElement' does not exist on type 'FormControl'".
    ...
    */
    ...
    var NativeElementInjectorDirective = /*#__PURE__*/function () {
      function NativeElementInjectorDirective(controlDir, host) {
        _classCallCheck(this, NativeElementInjectorDirective);

        this.controlDir = controlDir;
        this.host = host;
      }

      _createClass(NativeElementInjectorDirective, [{
        key: "ngOnInit",
        value: function ngOnInit() {
    ...
    NativeElementInjectorDirective.ɵfac = function NativeElementInjectorDirective_Factory(t) {
      return new (t || NativeElementInjectorDirective)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_3__["NgControl"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdirectiveInject"](_angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]));
    };

    NativeElementInjectorDirective.ɵdir = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineDirective"]({
      type: NativeElementInjectorDirective,
      selectors: [["", "ngModel", ""], ["", "formControl", ""], ["", "formControlName", ""]]
    });

    NativeElementInjectorDirective.ctorParameters = function () {
      return [{
    ...
    NativeElementInjectorDirective = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_forms__WEBPACK_IMPORTED_MODULE_3__["NgControl"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ElementRef"]])], NativeElementInjectorDirective);
    var NgxIntlTelInputModule_1;

    var NgxIntlTelInputModule = NgxIntlTelInputModule_1 = /*#__PURE__*/function () {
      function NgxIntlTelInputModule() {
        _classCallCheck(this, NgxIntlTelInputModule);
      }

      _createClass(NgxIntlTelInputModule, null, [{
        key: "forRoot",
    ...
    NgxIntlTelInputModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: NgxIntlTelInputModule
    });
    NgxIntlTelInputModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function NgxIntlTelInputModule_Factory(t) {
        return new (t || NgxIntlTelInputModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_6__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_4__["BsDropdownModule"].forRoot(), ngx_bootstrap_tooltip__WEBPACK_IMPORTED_MODULE_5__["TooltipModule"].forRoot()]]
    });
    /*@__PURE__*/

    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NgxIntlTelInputService, [{
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](CountryCode, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"]
      }], function () {
        return [];
      }, null);
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NgxIntlTelInputComponent, [{
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NativeElementInjectorDirective, [{
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](NgxIntlTelInputModule, {
        declarations: function declarations() {
          return [NgxIntlTelInputComponent, NativeElementInjectorDirective];
        },
        imports: function imports() {
          return [_angular_common__WEBPACK_IMPORTED_MODULE_6__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], ngx_bootstrap_dropdown__WEBPACK_IMPORTED_MODULE_4__["BsDropdownModule"], ngx_bootstrap_tooltip__WEBPACK_IMPORTED_MODULE_5__["TooltipModule"]];
        },
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](NgxIntlTelInputModule, [{
  ...
  function srcAppSignupSignupModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _language_buttons_language_buttons_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    ...
    SignupPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], ngx_intl_tel_input__WEBPACK_IMPORTED_MODULE_7__["NgxIntlTelInputModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _signup_routing_module__WEBPACK_IMPORTED_MODULE_5__["SignupPageRoutingModule"], _language_buttons_language_buttons_module__WEBPACK_IMPORTED_MODULE_9__["LanguageButtonsModule"]],
  ...
  function srcAppSignupSignupPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var SignupPage = /*#__PURE__*/function () {
      function SignupPage(statusBar, formBuilder, router, api) {
      ...
      _createClass(SignupPage, [{
        ...
        key: "rollList",
        value: function rollList() {
          var _this7 = this;

          this.api.user_roll().subscribe(function (data) {
            _this7.rolllist = data;
            _this7.rlist = _this7.rolllist.data;
          });
        }
      }, {
        ...
        value: function signup() {
          ...
          for (var v in this.reg_form.controls) {
          ...
          if (this.reg_form.valid) {
            ...
            this.api.signup(body).subscribe(function (data) {
              _this8.reg_process = false;
        ...
        key: "switchRole",
        value: function switchRole() {
          var _this9 = this;

          this.reg_form.get('role').valueChanges.subscribe(function (val) {
            var is_available_gemh = _this9.reg_form.get('is_available_gemh');

            var gemh_number = _this9.reg_form.get('gemh_number');

            var reason = _this9.reg_form.get('reason');
            ...
            if (val == _this9.api.Agents || val == _this9.api.Developer) {
