...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
  ...
  function srcAppHomeHomeModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    HomePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_8__["TranslateModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], ngx_angular_autocomplete__WEBPACK_IMPORTED_MODULE_6__["NgxAutocompleteModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["IonicModule"], _home_routing_module__WEBPACK_IMPORTED_MODULE_7__["HomePageRoutingModule"]],
  ...
  function srcAppHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var src_app_global_language_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! src/app/global/language.service */
    "./src/app/global/language.service.ts");

    var HomePage = /*#__PURE__*/function () {
      function HomePage(statusBar, router, formBuilder, zone, languageService, api) {
      ...
      _createClass(HomePage, [{
        ...
        key: "NewsDataGet",
        value: function NewsDataGet() {
          var _this = this;

          this.loading = true;
          this.api.DataGet().subscribe(function (data) {
            if (data.status == 1) {
        ...
        key: "featuredDataGet",
        value: function featuredDataGet() {
          var _this3 = this;

          this.loading = true;
          this.api.fetured().subscribe(function (data) {
            if (data.status == 1) {
              _this3.listSlider = data.data;
              _this3.len = _this3.listSlider.length > 0;
              _this3.loading = false;
            }
          });
        }
      }, {
        key: "listing_redirect",
        value: function listing_redirect() {
          this.router.navigate(["/listing"]);
        }
      }, {
        key: "InvestorsDataGet",
        value: function InvestorsDataGet() {
          var _this4 = this;

          this.loading = true;
          this.api.investors().subscribe(function (data) {
            if (data.status == 1) {
              _this4.investors = data.data;
