...
/* harmony import */ var _global_password_validation__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../global/password_validation */ "./src/app/global/password_validation.ts");
...
let ResetPage = class ResetPage {
    constructor(statusBar, formBuilder, router, navCtrl, route, api) {
    ...
    ngOnInit() { }
    isvalidToken(token) {
        this.api.verifytoken(token).subscribe((data) => {
            if (data.token == true) {
...
ResetPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-reset',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./reset.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/reset/reset.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./reset.page.scss */ "./src/app/reset/reset.page.scss")).default]
    })
], ResetPage);
